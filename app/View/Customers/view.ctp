...
<div class="related">
	...
	<?php if (!empty($customer['Property'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Property No'); ?></th>
		<th><?php echo __('Customer Id'); ?></th>
		<th><?php echo __('P Name'); ?></th>
		<th><?php echo __('P Address'); ?></th>
		<th><?php echo __('P City'); ?></th>
		<th><?php echo __('P State'); ?></th>
		<th><?php echo __('P Zip'); ?></th>

	</tr>
	<?php foreach ($customer['Property'] as $property): ?>
		<tr>
			<td><?php echo $property['property_no']; ?></td>
			<td><?php echo $property['customer_id']; ?></td>
			<td><?php echo $property['p_name']; ?></td>
			<td><?php echo $property['p_address']; ?></td>
			<td><?php echo $property['p_city']; ?></td>
			<td><?php echo $property['p_state']; ?></td>
			<td><?php echo $property['p_zip']; ?></td>
